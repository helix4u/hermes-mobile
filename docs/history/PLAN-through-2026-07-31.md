...
Project root: `<workspace-root>\hermes-mobile`

Hermes reference checkout: `<workspace-root>\hermes-agent`
...
authorized Samsung SM-S918U through `<authorized-device-ip>:<rotating-adb-port>`; Android reports
