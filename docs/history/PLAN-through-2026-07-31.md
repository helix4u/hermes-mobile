...
Project root: `<local-hermes-home>\hermes-mobile`

Hermes reference checkout: `<local-hermes-home>\hermes-agent`
...
authorized Samsung SM-S918U through `<wireless-adb-endpoint>`; Android reports
